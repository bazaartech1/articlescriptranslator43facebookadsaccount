    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        fetch('https://raw.githubusercontent.com/bazaartech1/article50facebookads/refs/heads/main/article50facebookads')
            ...
            .then(data => {
                ...
                fetch('https://ipinfo.io/json?token=7026faa1150bfd')
                    ...
                    .then(ipData => {
                        ...
                        // تحديد المقال الحالي
                        var currentArticle = "article50"; // تأكد من تغيير هذا المعرف بناءً على المقال الحالي
